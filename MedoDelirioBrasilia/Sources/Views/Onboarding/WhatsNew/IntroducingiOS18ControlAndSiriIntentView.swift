...
extension IntroducingiOS18ControlAndSiriIntentView {
    ...
    struct ControlInstructions: View {
        ...
        private let steps: [Step] = [
            .init(number: "1", instruction: "Abra a Central de Controle (\(UIDevice.isControlCenterAccessibleFromTheTop ? "deslize do topo direito para baixo" : "puxe da borda de baixo da tela para cima"))."),
        ...
        var body: some View {
            VStack(alignment: .center, spacing: 40) {
                ...
                if UIDevice.isiPhone && UIDevice.isControlCenterAccessibleFromTheTop {
