        ...
        do {
            ...
            soundData.forEach { sound in
                do {
                    ...
                    Logger.shared.logSyncError(description: "Erro ao tentar importar Som '\(sound.title)': \(error.localizedDescription)", updateEventId: "")
                }
            }
            ...
            Logger.shared.logSyncError(description: "Erro ao tentar importar Sons: \(error.localizedDescription)", updateEventId: "")
        }
    }
        ...
        do {
            ...
            authorData.forEach { author in
                do {
                    ...
                    Logger.shared.logSyncError(description: "Erro ao tentar importar Autor '\(author.name)': \(error.localizedDescription)", updateEventId: "")
                }
            }
            ...
            Logger.shared.logSyncError(description: "Erro ao tentar importar Autores: \(error.localizedDescription)", updateEventId: "")
        }
    }
}
        ...
        do {
            ...
            songData.forEach { song in
                do {
                    ...
                    Logger.shared.logSyncError(description: "Erro ao tentar importar Música '\(song.title)': \(error.localizedDescription)", updateEventId: "")
                }
            }
            let songCount = try LocalDatabase.shared.songCount()
            Logger.shared.logSyncSuccess(description: "\(songCount) Músicas importadas dos dados fixos com sucesso.", updateEventId: "")
        } catch {
            Logger.shared.logSyncError(description: "Erro ao tentar importar Músicas: \(error.localizedDescription)", updateEventId: "")
        }
    }
        ...
        do {
            ...
            genreData.forEach { genre in
                do {
                    ...
                    Logger.shared.logSyncError(description: "Erro ao tentar importar Gênero Musical '\(genre.name)': \(error.localizedDescription)", updateEventId: "")
                }
            }
            ...
            Logger.shared.logSyncError(description: "Erro ao tentar importar Gêneros Musicais: \(error.localizedDescription)", updateEventId: "")
        }
    }
}
