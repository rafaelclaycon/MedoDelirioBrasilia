...
enum MusicGenre: String, CaseIterable, Identifiable, Codable {
    case all, arrocha, carimbo, electronic, funk, undefined, house, jingle, lambada, marchinha, metal, mpb, pagode, pisero, pop, reggae, rock, samba, sertanejo, tecno, variousGenres, tvIntro
